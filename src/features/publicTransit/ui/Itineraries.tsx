import { conversionSecToHour, TakeTimeToGo } from '@/features/navigate';
import { TransitLeg } from '@/features/publicTransit';
...
export default function Itineraries({
  ...
  legs,
  ...etc
}: PUBLICTRANSIT.Itinerary) {
  const totalWalkTime = conversionSecToHour(etc.totalWalkTime);
  return (
    <>

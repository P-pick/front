...
import { carFollowInfo } from '@/pages/const/FOLLOW';
...
interface CarFollowProps {
  followFeatures: CarFeatures[];
}

export default function CarFollow({ followFeatures }: CarFollowProps) {
            ...
            >
              <div className="w-full h-full border-2 border-(--color-primary-red) bg-(--color-primary-red) rounded-2xl p-2 flex flex-col items-start justify-center gap-2">
                <div className="flex gap-2">
                  <div>
                    <span>{carFollowInfo[option.turnType].svg}</span>
                  </div>

...
import type { PedestrianFeatures, PedestrianFollowFeature } from '../../types';
...
interface PedestrianFollowProps {
  followFeatures: PedestrianFeatures[];
}

export default function PedestrianFollow({
  followFeatures,
}: PedestrianFollowProps) {
  ...
  const followList = useMemo(() => {
    return getSelectedTransportationFollow(
      vehicle,
      followFeatures
    ) as PedestrianFollowFeature[];
